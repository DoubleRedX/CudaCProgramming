...
#ifndef HIP_RUNTIME_METAPROGRAMMING_H
#define HIP_RUNTIME_METAPROGRAMMING_H
...
#define NVCV_CUDA_TYPE_TRAITS(COMPOUND_TYPE, BASE_TYPE, COMPONENTS, ELEMENTS, MIN_VAL, MAX_VAL) \
    ...
    NVCV_CUDA_TYPE_TRAITS(char, char, 0, 1, CHAR_MIN, CHAR_MAX);  // add for hip that char1 is filled with char
...
//    NVCV_CUDA_TYPE_TRAITS_1_TO_4(hip_schar, signed char, SCHAR_MIN, SCHAR_MAX);  // add for hip
//NVCV_CUDA_TYPE_TRAITS_1_TO_4(char, signed char, SCHAR_MIN, SCHAR_MAX);
    NVCV_CUDA_TYPE_TRAITS_1_TO_4(char, char, CHAR_MIN, CHAR_MAX);  // add for hip that char1 is filled with char
...
#undef NVCV_CUDA_MAKE_TYPE
    ...
    template<class T, int C>
    using MakeType_t = typename MakeType<T, C>::type;
...
#endif //HIP_RUNTIME_METAPROGRAMMING_H
